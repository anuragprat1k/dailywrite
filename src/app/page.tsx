    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
      <header className="container mx-auto px-4 py-6">
        <nav className="flex items-center justify-between">
          <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">WriteFlow</div>
          <Link
            href="/login"
      ...
      <main className="container mx-auto px-4 py-20">
        ...
        <div className="mt-24 grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 dark:bg-slate-800 dark:border-slate-700">
            <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/50 rounded-lg flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Organize Projects</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 dark:bg-slate-800 dark:border-slate-700">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Track Progress</h3>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 dark:bg-slate-800 dark:border-slate-700">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Focus on Writing</h3>
            <p className="text-gray-600 dark:text-gray-400">
      ...
      <footer className="container mx-auto px-4 py-8 mt-20 border-t border-gray-100 dark:border-slate-700">
